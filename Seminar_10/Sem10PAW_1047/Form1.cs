    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while(reader.Read())
                {
                    ...
                    itm.SubItems.Add(reader["sumaPlata"].ToString());
            ...
            try
            {
                ...
                foreach(ListViewItem itm in listView1.Items)
                    if(itm.Checked)
                    {
                        ...
                        comanda.CommandText = "UPDATE abonati SET categorie='" + comboBox1.Text + "' WHERE ID=" + id;
        ...
        private void dELETEToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (ListViewItem itm in listView1.Items)
                    ...
                    {
                        int id = Convert.ToInt32(itm.SubItems[0].Text);
                        comanda.CommandText = "DELETE FROM abonati WHERE ID=" + id;
                        comanda.ExecuteNonQuery();
                    }
            }
            catch (Exception ex)
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                OleDbCommand comanda = new OleDbCommand();
                comanda.Connection = conexiune;
                comanda.CommandText = "CREATE PROCEDURE AbonatiCategorie AS SELECT * FROM abonati WHERE categorie=@categorie";
                comanda.ExecuteNonQuery();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                OleDbCommand comanda = new OleDbCommand();
                comanda.Connection = conexiune;
                comanda.CommandText = "AbonatiCategorie";
                comanda.CommandType = CommandType.StoredProcedure;
                comanda.Parameters.Add("@categorie", OleDbType.Char, 10).Value = "SILVER";
                OleDbDataReader reader = comanda.ExecuteReader();
                while (reader.Read())
                {
                    ListViewItem itm = new ListViewItem(reader["ID"].ToString());
