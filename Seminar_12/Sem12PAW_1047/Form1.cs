...
namespace Sem12PAW_1047
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            adaptor.Fill(dataSet, "studenti");
            DataTable tabela = dataSet.Tables["studenti"];
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            DataRow[] rows = tabela.Select("formaInvatamant='IF'", "nume");
            foreach (DataRow linie in rows)
                textBox1.Text += linie["nume"] + "   " + linie["formaInvatamant"] + Environment.NewLine;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            dv.RowFilter = "formaInvatamant='IF'";
            dv.Sort = "nume";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            adaptor.UpdateCommand = new OleDbCommand("UPDATE studenti SET medie=medie+0.1 WHERE nume='" + comboBox1.Text + "'", conexiune);
